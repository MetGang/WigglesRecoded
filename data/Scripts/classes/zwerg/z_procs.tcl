...
proc base_exp_factor {} {
	if { [im_in_campaign] } { return 1.0 } { return 2.0 }
}

#
proc clan_exp_factors {} {
	global clanname

	switch $clanname {
		"Voodoo_" {
			return {{exp_Nahrung 1.3} {exp_Holz 1.1} {exp_Kampf 0.9}}
		}
		"Knocker_" {
			return {{exp_Stein 1.2} {exp_Metall 1.1}}
		}
		"Brain_" {
			return {{exp_Energie 1.2} {exp_Service 1.1}}
		}
		"Vampir_" {
			return {{exp_Kampf 1.2} {exp_Nahrung 0.8}}
		}
		default {
			return {}
		}
...
proc harvest {obj} {
	...
	if { [inv_find this Kettensaege] == -1 } {
		...
		tasklist_add this "delete_shroom $obj; am_trigger_achv_step ChopChop; am_trigger_achv_step MoreTimber; call_method this gain_exp_points 2"
		tasklist_add this "change_tool 0"
	} else {
		# Chainsaw
...
proc open_box {obj} {
	...
	if { [get_objclass $obj] == "Schatzbuch" } {
		...
		tasklist_add this "read_book $obj"
	} else {
		...
		tasklist_add this "call_method $obj release_content [get_owner this]; am_trigger_achv_step Scavenger"
	}
}
