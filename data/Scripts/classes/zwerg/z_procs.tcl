...
proc base_exp_factor {} {
	if { [im_in_campaign] } {
		return [cfm_get_value_or "campaign.ExpFactor" 1.0]
	} else {
		return [cfm_get_value_or "skirmish.ExpFactor" 2.0]
	}
}
...
proc harvest {obj} {
	...
	if { [inv_find this Kettensaege] == -1 } {
		...
		tasklist_add this "delete_shroom $obj; call_method this gain_exp_points 2; stm_incr_stat_value MushroomsHarvested 1; am_trigger_achv_step ChopChop; am_trigger_achv_step MoreTimber; am_trigger_achv_step FastChopping"
		tasklist_add this "change_tool 0"
	} else {
		# Chainsaw
...
proc open_box {obj} {
	...
	if { [get_objclass $obj] == "Schatzbuch" } {
		...
		tasklist_add this "call_method $obj release_content [get_owner this]; am_trigger_achv_step Scavenger; stm_incr_stat_value BarrelsLooted 1"
	}
}
