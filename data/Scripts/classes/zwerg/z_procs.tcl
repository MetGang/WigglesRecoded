...
proc delete_shroom {obj} {
	...
	am_trigger_achv_step ChopChop
	am_trigger_achv_step MoreTimber
}
...
proc harvest {obj} {
	...
	if { [inv_find this Kettensaege] == -1 } {
		...
		tasklist_add this "delete_shroom $obj"
		tasklist_add this "change_tool 0"
	} else {
		# Chainsaw
...
proc open_box {obj} {
	...
	if { [get_objclass $obj] == "Schatzbuch" } {
		...
		tasklist_add this "call_method $obj release_content [get_owner this]"
		tasklist_add this "am_trigger_achv_step Scavenger"
	}
}
