...
def_class CheatManager none none 0 {} {
	...
	#
	method apply_config {} {
		call_method this set_cheating_enabled [cfm_get_value "main.cheats"]

		foreach key [db_cheats_keys] {
			call_method this set_cheat_enabled $key [cfm_get_value "cheats.$key"]
		}
	}
	...
	method toggle_cheat_enabled {key} {
		if { [call_method this is_cheat_enabled $key] } { set $key 0 } { set $key 1 }
	}
