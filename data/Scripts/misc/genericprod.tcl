...
//		log " Christoph *****: - $firstitem"
	...
	method get_buildupanim {} {
		...
		return [lindex [get_buildup_anims] [expr {$buildup_step - 1}]]
	}
	...
	method get_repairanim {step} {
		...
		return [lindex [get_buildup_anims] [expr {$step - 1}]]
	}
	...
	#
	method get_energy_consumed {} {
		return [get_energy_consumed]
	}

	#
	method get_energy_stored {} {
	...
	#
	method get_energy_fuel_yield {} {
		return [get_energy_fuel_yield]
	}
	...
	#
	proc get_energy_consumed {} {
		if { [get_objtype this] == "energy" } {
			return [get_energysourceload this]
		} else {
			return 0
		}
	}
