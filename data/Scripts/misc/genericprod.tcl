...
//		log " Christoph *****: - $firstitem"
	...
	proc get_energy_consumption {} {
		set classname [get_objclass this]
		global tttenergycons_$classname
		return [subst \$tttenergycons_$classname]
	}
	...
	proc get_energy_max_store {} {
		set classname [get_objclass this]
		global tttenergymaxstore_$classname
		return [subst \$tttenergymaxstore_$classname]
	}

	#
	proc get_energy_yield {} {
		set classname [get_objclass this]
		global tttenergyyield_$classname
		return [subst \$tttenergyyield_$classname]
	}

	#
	proc get_energy_class {} {
		set classname [get_objclass this]
		global tttenergyclass_$classname
		return [subst \$tttenergyclass_$classname]
	}

	#
	proc get_energy_range {} {
		set classname [get_objclass this]
		global tttenergyrange_$classname
		return [subst \$tttenergyrange_$classname]
	}
