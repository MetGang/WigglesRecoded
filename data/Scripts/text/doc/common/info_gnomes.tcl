...
proc gi_set_ordering {ordering} {
	global gi_ordering
	set gi_ordering $ordering
	gi_reload_layout
}

proc gi_btn_set_tab {tab lkey} {
	global gi_tab
	return [btn [lmsg $lkey] "gi_set_tab $tab" [expr {$gi_tab != $tab}]]
}

proc gi_btn_set_ordering {ordering lkey} {
	global gi_ordering
	return [btn [lmsg $lkey] "gi_set_ordering $ordering" [expr {$gi_ordering != $ordering}]]
}
