...
proc di_render_info_section_energy {} {
	...
	println_kv "EnergyConsumed" [call_method $id get_energy_consumed]
	println_kv "EnergyStored" [call_method $id get_energy_stored]
	println_kv "EnergyMaxStore" [call_method $id get_energy_max_store]
	println_kv "EnergyYield" [call_method $id get_energy_fuel_yield]
