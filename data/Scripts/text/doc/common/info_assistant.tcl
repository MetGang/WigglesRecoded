...
proc pi_render_subwindow_cheats {} {
	...
	println [btn Toggle "call_method $chman toggle_cheating_enabled; pi_reload_layout"]

	if { [call_method $chman is_cheating_enabled] } {
		foreach key [db_cheats_keys] {
			println_kv $key [btn [call_method $chman is_cheat_enabled $key] "call_method $chman toggle_cheat_enabled $key; pi_reload_layout"]
		}
	}
